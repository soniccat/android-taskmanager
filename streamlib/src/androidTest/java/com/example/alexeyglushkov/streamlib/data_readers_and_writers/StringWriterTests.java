...
public class StringWriterTests {
    ...
    public void testWriteString() throws Exception {
        // Arrange
        String testString = "It’s official, the Dropbox IPO filing is here.\n" +
                "\n" +
        ...
        OutputStreamDataWriters.writeOnce(writer, os, testString);
    ...
    private String getFilePath() {
        ...
        File testDir = appContext.getDir("StringWriterTestsDir", Context.MODE_PRIVATE);
        return testDir + "/testWriteString";
    }
}
