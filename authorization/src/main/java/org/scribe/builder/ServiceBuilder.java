...
public class ServiceBuilder
{
  ...
  public ServiceBuilder webClient(OAuthWebClient webClient) {
  ...
  public OAuthService build()
  {
    ...
    return api.createService(new OAuthConfig(apiKey, apiSecret, callback, signatureType, scope, webClient, debugStream));
  }
}
